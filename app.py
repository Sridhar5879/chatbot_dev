  ...
  if request.method == 'POST':
      ...
      try:
          ...
          if userid == 932245:
              ...
              result = "Hi %s, North India Sales '\n'please select a report from the following <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report NI.xlsx?raw=true'>NorthIndiaSalesReport</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report GH.xlsx?raw=true'>GujaratSalesReport</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report PJB.xlsx?raw=true'>PunjabSalesReport</a> "%name
          elif userid == 415250:
