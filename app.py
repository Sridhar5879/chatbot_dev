...
def order_status():
  if request.method == 'POST':
      ...
      try:
          ...
          name =names[0]
          result = "Hi %s, please select a report from the following <a href = 'https://github.com/techwave-analytics/chatbot-cgl-dev/blob/master/Sales report GH.xlsx?raw=true'>Global Report</a> <a href = 'https://github.com/techwave-analytics/chatbot-cgl-dev/blob/master/Sales report NI.xlsx?raw=true'>North India Report</a> <a href = 'https://github.com/techwave-analytics/chatbot-cgl-dev/blob/master/Sales report PJB.xlsx?raw=true'>Punjab Report</a> <a href = 'https://github.com/techwave-analytics/chatbot-cgl-dev/blob/master/Sales report SI.xlsx?raw=true'>South India Report</a> <a href = 'https://github.com/techwave-analytics/chatbot-cgl-dev/blob/master/Sales report TG.xlsx?raw=true'>Telangana Report</a>  "%name
          aa['result'] = result
          return aa
      except ValueError:
