  ...
  if request.method == 'POST':
      ...
      try:
          ...
          if userid == 932245:
              ...
              result = "Hi %s, South India Sales '\n' please select a report from the following <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report GH.xlsx?raw=true'>Global Report</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report SI.xlsx?raw=true'>South India Report</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report TG.xlsx?raw=true'>Telangana Report</a>  "%name
          elif userid == 934771:
              result = "Hi %s, North India Sales '\n'please select a report from the following <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report GH.xlsx?raw=true'>Global Report</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report NI.xlsx?raw=true'>North India Report</a> <a href = 'https://github.com/Sridhar5879/chatbot_dev/blob/master/Sales report PJB.xlsx?raw=true'>Punjab Report</a> "%name
          aa['result'] = result
          return aa
      except ValueError:
